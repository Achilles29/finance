...
-- ============================================================
-- Tahap 6D - Sidebar menu Opening Stok Purchase
-- ============================================================
START TRANSACTION;

INSERT INTO sys_page (page_code, page_name, module, description, is_active)
VALUES
  ('purchase.stock.opening.index', 'Purchase Stock Opening', 'PURCHASE', 'Input dan monitoring opening stok gudang/divisi', 1)
...
JOIN sys_page p ON p.page_code = 'purchase.stock.opening.index'
...
WHERE p.page_code = 'purchase.stock.opening.index';
