...
SELECT
  ...
  0 AS scheduled_work_minutes,
  0 AS corrected_work_minutes,
  0 AS corrected_late_minutes,
  0 AS corrected_early_leave_minutes,
  0 AS corrected_overtime_minutes,
  0.00 AS basic_daily_rate,
  0.00 AS allowance_daily_rate,
  0.00 AS corrected_basic_amount,
  0.00 AS corrected_allowance_amount,
  0.00 AS corrected_meal_amount,
  0.00 AS corrected_overtime_pay,
  0.00 AS corrected_late_deduction_amount,
  0.00 AS corrected_alpha_deduction_amount,
  0.00 AS corrected_gross_amount,
  0.00 AS corrected_net_amount,
  0.00 AS corrected_daily_salary_amount
FROM att_daily ad
