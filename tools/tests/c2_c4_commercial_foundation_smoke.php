...
$check(is_array($manifest) && ($manifest['version'] ?? '') === '0.1.0-alpha.10' && ($manifest['schema_version'] ?? '') === 'finance-20260907', 'commercial source advances without inventing a schema migration');
