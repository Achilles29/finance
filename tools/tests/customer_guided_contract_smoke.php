...
$check($profile['profile_version']===10&&$profile['setup_contract']==='FINANCE_GUIDED_SETUP_V1'&&$profile['installation_permission_policy']==='UNTIL_USED_OR_REVOKED','new signed guided contract without installation deadline');
