...
$plan=a55t_run([PHP_BINARY,$root.'/tools/db/migration_runner.php','plan','--policy=upgrade'],$root,['PATH'=>'/usr/bin:/bin']);$planJson=json_decode(trim($plan['out']),true);$check($plan['code']===0&&array_column($planJson['migrations']??[],'id')===['2026-09-04c-a5-schema-migration-registry-foundation','2026-09-05e-whatsapp-safe-reference-seed','2026-09-05a-telegram-bot-foundation','2026-09-05b-telegram-setup-guide','2026-09-05c-telegram-safe-activation-default','2026-09-06a-component-formula-version-history','2026-09-06b-component-formula-restore-action','2026-09-06c-pos-mobile-reversal-step-up','2026-09-06d-pos-mobile-reprint-step-up','2026-09-06e-activity-audit-foundation'],'catalog plan contains all ten managed upgrade migrations in dependency order');
