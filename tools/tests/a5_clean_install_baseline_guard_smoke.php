...
$check($result['ok'] === true && $result['table_count'] === 284, 'canonical schema baseline and checksum validate');
...
$check(substr_count($schema, 'CREATE TABLE `') === 284, 'baseline contains exactly 284 unique schema tables');
