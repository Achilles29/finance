...
$check($result['ok'] === true && $result['table_count'] === 285, 'canonical schema baseline and checksum validate');
...
$check(substr_count($schema, 'CREATE TABLE `') === 285, 'baseline contains exactly 285 unique schema tables');
