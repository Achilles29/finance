...
$check($result['ok'] === true && $result['table_count'] === 282, 'canonical schema baseline and checksum validate');
...
$check(substr_count($schema, 'CREATE TABLE `') === 282, 'baseline contains exactly 282 unique schema tables');
