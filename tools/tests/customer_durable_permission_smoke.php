...
foreach([1800000000,1900000000,2000000000]as$at){PortablePackage::assertPermissionWindow($p,8,true,$at);$check(true,'Signed v8 window has no installation deadline');$check(!SetupUi::permissionExpired($p+['profile_version'=>8],$at),'UI agrees after years of waiting');}
...
foreach([6,7,9]as$v)$reject($p,$v,'SETUP_PERMISSION_BINDING_INVALID');
