...
try {
    ...
    $r=LinuxPreparation::command($prepArgs,"SIAP\n");$check($r['code']!==0&&str_contains($r['err'],'SETUP_PERMISSION_EXPIRED')&&!is_file($root.'/private/agent/agent.json'),'expired permit cannot be bypassed by root preparation');$signPermit($permit);
