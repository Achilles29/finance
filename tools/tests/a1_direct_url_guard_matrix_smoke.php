...
$manifest = [
    ...
    ['family' => 'Relation formula', 'route' => 'master/relation/component-formula/(:num)/store', 'target' => 'master_relation/component_formula_store/$1', 'controller' => 'Master_relation.php', 'method' => 'component_formula_store', 'policy' => 'formula:create + POST/scoped CSRF', 'smoke' => 'master_relation_component_formula_mutation_csrf_smoke.php'],
