...
function a511_run_drill(string $bundleDir, string $adminOption, string $evidenceDir): array
{
    ...
    if ($managedIds !== ['2026-09-04c-a5-schema-migration-registry-foundation', '2026-09-05e-whatsapp-safe-reference-seed', '2026-09-05a-telegram-bot-foundation', '2026-09-05b-telegram-setup-guide', '2026-09-05c-telegram-safe-activation-default']) {
    ...
    try {
        ...
        if (($migration['applied'] ?? null) !== 5 || ($migration['skipped'] ?? null) !== 0 || ($replay['applied'] ?? null) !== 0 || ($replay['skipped'] ?? null) !== 5) {
    ...
    $evidence = [
        ...
        'registry'=>['state'=>$registryRows === 5 ? 'COMPATIBLE_V1' : 'not_verified','bootstrap_rows'=>$registryRows],
