...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="pos-report-shell">
    <div class="pos-report-hero mb-3">
      ...
      <p class="pos-report-copy mb-0">Ringkasan performa extra per item. Nilai dihitung dari line extra POS, refund extra, net, dan estimasi gross profit.</p>
    </div>
    ...
    <div class="row g-3 mb-3">
      ...
      <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="pos-report-card">
          ...
          <div class="pos-report-card-note">Gross extra dikurangi refund.</div>
        </div>
      </div>
    </div>
    ...
    <div class="pos-report-section p-3">
      <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
          ...
          <div class="pos-report-meta">Gross hanya dari line extra, sehingga tidak dobel dengan nilai produk.</div>
        </div>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-sm align-middle mb-0 pos-report-table">
            ...
            <tbody>
              <?php if (empty($rows)): ?>
                <tr>
                  <td colspan="10" class="text-center pos-report-empty">Belum ada data extra untuk filter yang dipilih.</td>
                </tr>
              <?php else: ?>
