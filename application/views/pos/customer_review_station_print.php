...
$qrUrl = 'https://api.qrserver.com/v1/create-qr-code/?size=720x720&ecc=H&data=' . rawurlencode($stationUrl);
?>
<!doctype html>
<html lang="id">
<head>
