...
(function() {
      ...
      return `
        <tr>
          ...
          <td>
            ...
            <div class="self-order-subtle">${escapeHtml(row.table_no || 'Delivery')} | ${escapeHtml(row.member_mobile_phone || '-')}</div>
          </td>
          <td>
            ${paymentModeChip(row)}
  ...
  async function openDetail(orderId) {
    ...
    document.getElementById('self_order_detail_meta').textContent = `${header.order_no || '-'} | ${header.customer_display_name || header.member_name || 'Walk in'} | ${header.table_no || 'Delivery'}`;
    document.getElementById('self_order_detail_grid').innerHTML = [
      ['Customer', header.customer_display_name || header.member_name || 'Walk in'],
      ['Pengiriman', header.table_no || 'Delivery'],
  ...
  function syncVerifyDestinationSummary() {
    ...
    document.getElementById('self_order_verify_grid').innerHTML = [
      ...
      ['Pengiriman', verifyRow.table_no || 'Delivery'],
  ...
  function openReject(row) {
    ...
    document.getElementById('self_order_reject_grid').innerHTML = [
      ...
      ['Pengiriman', row.table_no || 'Delivery'],
