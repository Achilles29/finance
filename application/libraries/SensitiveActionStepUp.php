...
class SensitiveActionStepUp
{
    ...
    private const ACTIONS = ['VOID', 'REFUND', 'PERIOD_REOPEN', 'ORDER_REPRINT', 'COMPONENT_ADJUSTMENT_POST', 'COMPONENT_ADJUSTMENT_VOID', 'COMPONENT_BATCH_POST', 'COMPONENT_BATCH_VOID', 'COMPONENT_DAILY_RECON_POST', 'STOCK_ADJUSTMENT_POST', 'STOCK_ADJUSTMENT_VOID', 'STOCK_TRANSFER_POST', 'STOCK_TRANSFER_VOID', 'STOCK_OPENING_POST', 'STOCK_OPENING_VOID'];
