...
class SensitiveActionStepUp
{
    ...
    private const ACTIONS = ['VOID', 'REFUND', 'PERIOD_REOPEN', 'ORDER_REPRINT', 'COMPONENT_ADJUSTMENT_POST', 'COMPONENT_ADJUSTMENT_VOID', 'STOCK_ADJUSTMENT_POST', 'STOCK_ADJUSTMENT_VOID'];
