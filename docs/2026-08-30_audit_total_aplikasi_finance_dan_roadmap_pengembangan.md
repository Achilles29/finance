...
**Pembaruan status eksekusi:** 2026-09-05, setelah Batch 159 menambahkan
...
| A1 — security/RBAC/scope | `IN_PROGRESS` | `STAGING_PASS` | `BLOCKED` | `PARTIAL` | Multi-role/scope web-mobile terbukti fail-closed di staging; web Void/Refund/Reopen/Reprint serta Posting Adjustment Base/Prepare telah memakai reauth satu-kali, tetapi baseline izin per jabatan, MFA, step-up aksi lain/mobile, dan UAT role/APK belum selesai. |
