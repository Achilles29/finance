...
**Pembaruan status eksekusi:** 2026-09-06, setelah Batch 161 menambahkan
CSRF scoped dan verifikasi ulang password pada Post/VOID Adjustment Stok
...
| A1 — security/RBAC/scope | `IN_PROGRESS` | `STAGING_PASS` | `BLOCKED` | `PARTIAL` | Multi-role/scope web-mobile terbukti fail-closed di staging; web Void/Refund/Reopen/Reprint, Post/VOID Adjustment Base/Prepare, serta Post/VOID Adjustment Stok Gudang/Divisi telah memakai reauth satu-kali, tetapi baseline izin per jabatan, MFA, step-up aksi lain/mobile, dan UAT role/APK belum selesai. |
