...
| `baseline/2026-09-05_clean_install_schema.sql` | Clean-install schema-only | `STAGING_PASS` | 285 tabel dan checksum terkunci; catalog clean-install berisi sepuluh migration termasuk history/restore Formula serta proof Void/Refund/Reprint POS Mobile. | `NOT_FOR_UPGRADE` | Hanya titik awal database customer baru, dilanjutkan migration runner policy clean_install. |

Migration runner kini mengelola sepuluh file: `2026-09-04c`, clean-install-only
...
`2026-09-06c`–`2026-09-06d` proof reversal/reprint POS Mobile.
