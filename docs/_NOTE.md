...
bagian Hutang Stok Negatif, ubah tampilannya menjadi tab bertingkat. tab pertama adalah tab divisi (bar / kitchen), tab kedua adalah tab bahan baku dan tab component (base/prepare) berasarkan divisinya


di inv bahan baku divisi, matrix daily, daily-recon, stock, stock bulanan,  buat nama bahan bakunya menjadi hiperlink ke halaman penggunaan pada /master/material/usage/
