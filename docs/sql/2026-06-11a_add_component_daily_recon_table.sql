-- ============================================================
-- 2026-06-11a  Tambah tabel inv_component_stock_opname
-- Digunakan untuk menyimpan hasil hitung fisik stok component
-- per tanggal daily recon, dipakai oleh
-- /production/component-daily-recon.
--
-- Idempotent: CREATE TABLE IF NOT EXISTS + ON DUPLICATE KEY.
-- ============================================================
